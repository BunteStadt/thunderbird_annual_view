...
- **Duration Filter Toggle (Header)**: Quickly enable or disable duration/all-day filtering without changing calendar selection. When off, all events from selected calendars are shown.
