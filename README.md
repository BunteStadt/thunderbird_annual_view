...
A slim container is available for local development and automated e2e testing. It mounts the repository into `/workspace`, installs Thunderbird from the distribution package repository, and exposes a browser-accessible Thunderbird GUI over the container's noVNC endpoint.
