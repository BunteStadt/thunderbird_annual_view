...
- a standalone HTML debug surface for local development via built-in ICS demo data
...
- Keep Google web integration isolated behind provider/adapters so the renderer stays host-agnostic.
